    ...
    return (
        ...
        >
            ...
            <ProjectPhoneWithMarquee
                ...
                keywordsRow1={["평균 타수", "동반자의 정보", "홀 별 스코어", "핸디캡", "베스트 라운드"]}
                keywordsRow2={["라운드 히스토리", "라운드별 타수 편차", "동반자와의 평균 비교", "최악의 라운드", "코스별 성적 비교"]}
                keywordsRow3={["라운드별 스코어 변화 추이", "홀별 퍼포먼스 비교", "각 홀의 파 정보", "홀 인원수", "특정 파 유형"]}
                bgColor="bg-[#010101]"
            />
